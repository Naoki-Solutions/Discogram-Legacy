...
<div class="maincontainer">
    ...
    <p style="padding-left:6rem;margin:0;">Aqui podras escuchar musica de distintas emisoras a traves del mundo.</p>
    <p style="padding-left:6rem;margin:0;">Si encuentras algun bug, no olvides reportarlo en nuestro servidor de Discord.</p>
    <br>
    <hr>
    <h3 style="padding-left:6rem;">Emisoras</h3>
    <p style="padding-left:6rem;margin:0;">Puerto Rico: <a href="radio-pr"><span style="margin:0;color:green;font-family: 'Inconsolata', monospace;">Click para ver</span></a></p>
</div>
</div>
