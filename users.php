...
<div class="maincontainer">
    ...
    <h2 style="padding-left:6rem;">Usuarios de Naoki OnNet</h2>
    <p style="padding-left:6rem;margin:0;">Aqui podras encontrar los usuarios que participaron de alguna forma</p>
    <p style="padding-left:6rem;margin:0;">en el desarrollo de Naoki OnNet.</p>
    <hr>
    <div class="user1">
    <span style="padding:10px;margin:0;top:100px">xKeyder_#0425</span>
</div>
