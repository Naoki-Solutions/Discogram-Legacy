...
<div class="maincontainer">
    ...
    <p style="padding-left:7rem;">Este es un grupo oficial de NeticsSH, aqui podras encontrar<br>cosas relacionadas con la aplicacion y con la empresa.</p>
    <h2 style="padding-left:7rem;">Eventos Proximos</h2>
    <p style="padding-left:7rem;">Aqui podras encontrar un listado de todos los eventos proximos.</p>
    <h3 style="padding-left:7rem;">Event Status</h3>
    <p style="padding-left:7rem;">Event: <span style="color:red;">none</span><br>
    Next Event: <span style="color:red;">none</span></p>
</div>
...
<h4 style="padding-left:10px;"><i class="fa-solid fa-hashtag"></i> Server Info</h4>
<hr>
<h4 style="padding-left:10px;">???</h4>
<p style="padding-left:10px;"><i class="fa-regular fa-calendar-check"></i> ???</p>
<p style="padding-left:10px;"><i class="fa-regular fa-calendar-check"></i> ???</p>
<p style="padding-left:10px;"><i class="fa-regular fa-calendar-check"></i> ???</p>
