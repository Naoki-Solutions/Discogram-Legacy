...
<div class="test">
    ...
    <a href="./settings"><h1 style="font-size:20px;padding:26rem;padding-left:14px;"><i style="color:#85898f;" class="fa-solid fa-gear"></i></h1></a>
</div>

<div class="test2">
<h4 style="padding-left:20px;"><i class="fa-solid fa-hashtag"></i> <a style="color:#85898f;" href="./cdp-general.php">general</a></h4>
